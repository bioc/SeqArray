	...
	var.index = FALSE, ...)
{
	...
	stopifnot(is.logical(var.index) & (length(var.index)==1))
...
{
	# check
	stopifnot(is.character(gdsfile) | inherits(gdsfile, "gds.class"))
...
# {
# 	# check
# 	stopifnot(inherits(gds.obj, "gds.class"))
